...
s=df[df["CRIME HEAD"]=="INSULT TO THE MODESTY OF WOMEN"]
...
plt.xlabel("Year")
plt.ylabel("Number of insult to the modesty of women")
plt.title("Total insult to the modesty of women year wise")
plt.show()
l=l.reset_index()
print(l)
...
plt.xlabel("Year")
plt.ylabel("Number of insult to the modesty of women ")
plt.title("Total ainsult to the modesty of women year wise")
...
plt.xlabel("States")
plt.ylabel("Number of insult to modesty of women  statewise")
plt.title("Insult to modesty of women  state wise")
plt.show()
