...
s=df[df["CRIME HEAD"]=="CRUELTY BY HUSBAND OR RELATIVES"]
...
plt.xlabel("Year")
plt.ylabel("Number of cruelty by husband or relatives")
plt.title("Total cruelty by husband or relatives year wise")
plt.show()
l=l.reset_index()
print(l)
...
plt.xlabel("States")
plt.ylabel("Number of cruelty by relatives  statewise")
plt.title(" Cruelty by relatives  state wise")
plt.show()
