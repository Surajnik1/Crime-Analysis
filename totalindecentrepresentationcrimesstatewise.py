...
s=df[df["CRIME HEAD"]=="INDECENT REPRESENTATION OF WOMEN(PREVENTION)ACT"]
...
plt.xlabel("Year")
plt.ylabel("Number of indecent representation of women act")
plt.title("Total indecent representation of women act year wise")
plt.show()
l=l.reset_index()
print(l)
...
plt.xlabel("States")
plt.ylabel("Number of indecent represent. of women act  statewise")
plt.title("Inecent Representation of Women Act state wise")
plt.show()
