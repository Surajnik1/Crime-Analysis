...
s=df[df["CRIME HEAD"]=="KIDNAPPING & ABDUCTION"]

# YEAR WISE
l=s[s["STATE/UT"]=="ALL INDIA K&A"]
print(l)
...
plt.title("Total kidnapping and abduction")
plt.show()
l=l.reset_index()
print(l)
...
plt.xlabel("States")
plt.ylabel("Number of K&A statewise")
plt.title("Total K&A state wise")
plt.show()
