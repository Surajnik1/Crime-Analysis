...
s=df[df["CRIME HEAD"]=="IMMORAL TRAFFIC(PREVENTION)ACT"]
...
plt.xlabel("Year")
plt.ylabel("Number of prevention act")
plt.title("Total prevention act year wise")
plt.show()
l=l.reset_index()
print(l)
...
plt.xlabel("States")
plt.ylabel("Number of immortal traffic act  statewise")
plt.title("Immortal Traffic Act state wise")
plt.show()
