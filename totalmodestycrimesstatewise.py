...
s=df[df["CRIME HEAD"]=="ASSAULT ON WOMEN WITH INTENT TO OUTRAGE HER MODESTY"]
...
plt.xlabel("Year")
plt.ylabel("Number of assault on women")
plt.title("Total assault on women year wise")
plt.show()
l=l.reset_index()
print(l)
...
plt.xlabel("States")
plt.ylabel("Number of assault on women  statewise")
plt.title("Total assault on women  state wise")
plt.show()
